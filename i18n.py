...
TRANSLATIONS = {
    ...
    'Documente & rapoarte': {'en': 'Documents & reports'},
    ...
    # === Faza 13 - Corespondenta + Revendicari + Conflict detection ===
    'Corespondenta': {'en': 'Correspondence'},
    'Inregistrare noua': {'en': 'New entry'},
    'Editeaza corespondenta': {'en': 'Edit correspondence'},
    'Inregistrare corespondenta noua': {'en': 'New correspondence entry'},
    'Nicio corespondenta inregistrata': {'en': 'No correspondence registered'},
    'Sigur stergi aceasta corespondenta?': {'en': 'Delete this correspondence?'},
    'Numar inregistrare': {'en': 'Registration no.'},
    'Data inregistrare': {'en': 'Registration date'},
    'Subtip': {'en': 'Subtype'},
    'Directie': {'en': 'Direction'},
    'Primita': {'en': 'Received'},
    'Emisa': {'en': 'Issued'},
    'Expeditor': {'en': 'Sender'},
    'Destinatar': {'en': 'Recipient'},
    'Subiect': {'en': 'Subject'},
    'Continut': {'en': 'Content'},
    'Continut text': {'en': 'Text content'},
    'Continut text neinregistrat.': {'en': 'No text content registered.'},
    'Raspuns la (corespondenta anterioara)': {'en': 'Reply to (prior correspondence)'},
    'Raspunsuri': {'en': 'Replies'},
    'Este raspuns la': {'en': 'Is reply to'},
    'Adauga raspuns': {'en': 'Add reply'},
    'Genereaza termen 30 zile (regula notificare)': {'en': 'Generate 30-day deadline (notification rule)'},
    'Bifeaza pentru notificarile beneficiarului care impun raspuns in 30 zile. Sistemul va crea automat un TermenUrmarit cu data scadenta.':
        {'en': 'Check for beneficiary notifications requiring 30-day response. System will auto-create a tracked deadline.'},
    'Cu "notificare_cerinte_beneficiar" + checkbox-ul de mai jos -> termen automat 30 zile.':
        {'en': 'With "beneficiary_requirements_notice" + checkbox below -> auto 30-day deadline.'},
    'Termen 30 zile activ': {'en': '30-day deadline active'},
    'Scadenta': {'en': 'Due date'},
    'Depasit': {'en': 'Overdue'},
    'Indeplinit': {'en': 'Completed'},
    'Termen': {'en': 'Deadline'},
    'Parti': {'en': 'Parties'},
    'De la': {'en': 'From'},
    'Catre': {'en': 'To'},
    'Nr, subiect, expeditor...': {'en': 'No., subject, sender...'},

    'Revendicari': {'en': 'Claims'},
    'Revendicare': {'en': 'Claim'},
    'Revendicari (Claims)': {'en': 'Claims'},
    'Revendicare noua': {'en': 'New claim'},
    'Editeaza revendicare': {'en': 'Edit claim'},
    'Nicio revendicare inregistrata': {'en': 'No claims registered'},
    'Sigur stergi aceasta revendicare?': {'en': 'Delete this claim?'},
    'Numar revendicare': {'en': 'Claim number'},
    'Tip revendicare': {'en': 'Claim type'},
    'Initiaza revendicare': {'en': 'Initiate claim'},
    'Corespondenta initiatoare (optional)': {'en': 'Initiating correspondence (optional)'},
    'Corespondenta initiatoare': {'en': 'Initiating correspondence'},
    'Valoare solicitata': {'en': 'Requested value'},
    'Valoare solicitata (RON)': {'en': 'Requested value (RON)'},
    'Zile prelungire solicitate': {'en': 'Requested extension days'},
    'Prelungire solicitata': {'en': 'Requested extension'},
    'Zile preg.': {'en': 'Ext. days'},
    'Valori solicitate': {'en': 'Requested values'},
    'Status si decizie': {'en': 'Status and decision'},
    'Data decizie': {'en': 'Decision date'},
    'Motivare decizie': {'en': 'Decision rationale'},
    'In analiza': {'en': 'Under analysis'},
    'Negociere': {'en': 'Negotiation'},
    'Nr, descriere...': {'en': 'No., description...'},
    'zile': {'en': 'days'},

    'Conflicte': {'en': 'Conflicts'},
    'Conflicte detectate': {'en': 'Detected conflicts'},
    'Niciun conflict detectat cu state-ul curent al proiectului.':
        {'en': 'No conflicts detected with current project state.'},
    'Severitate': {'en': 'Severity'},
    'Entitate': {'en': 'Entity'},
    ...
    'Adauga legatura': {'en': 'Add link'},
    'Legatura': {'en': 'Link'},
    'Sterge aceasta legatura?': {'en': 'Delete this link?'},
    'Tip legatura': {'en': 'Link type'},
    'Termene legate': {'en': 'Linked deadlines'},
    'Taskuri legate': {'en': 'Linked tasks'},
    'Cantitati legate': {'en': 'Linked quantities'},
    'Nicio legatura cu termene contractuale.': {'en': 'No link to contractual deadlines.'},
    'Nicio legatura cu taskuri program.': {'en': 'No link to program tasks.'},
    'Nicio legatura cu cantitati executate.': {'en': 'No link to executed quantities.'},
    'Termen contractual': {'en': 'Contractual deadline'},
    'Task program': {'en': 'Program task'},
    'Cantitate executata': {'en': 'Executed quantity'},
    'Pozitie BoQ': {'en': 'BoQ position'},

    # === Locatii proiect (Mapbox integration) ===
    'Locatii': {'en': 'Locations'},
    'Locatii proiect': {'en': 'Project locations'},
    'Locatie noua': {'en': 'New location'},
    'Editeaza locatie': {'en': 'Edit location'},
    'Adauga locatie': {'en': 'Add location'},
    'Adauga prima locatie': {'en': 'Add first location'},
    'Nume locatie': {'en': 'Location name'},
    'Tip locatie': {'en': 'Location type'},
    'Nicio locatie inregistrata': {'en': 'No location registered'},
    'Sigur stergi aceasta locatie?': {'en': 'Delete this location?'},
    'Total locatii': {'en': 'Total locations'},
    'Cu coordonate': {'en': 'With coordinates'},
    'Latitudine': {'en': 'Latitude'},
    'Longitudine': {'en': 'Longitude'},
    'Coordonate': {'en': 'Coordinates'},
    'Adresa': {'en': 'Address'},
    'Judet': {'en': 'County'},
    'Localitate': {'en': 'Locality'},
    'Cauta coordonate din adresa': {'en': 'Find coordinates from address'},
    'Geocodeaza automat adresa la salvare (server-side)': {'en': 'Auto-geocode address on save (server-side)'},
    'Click pe harta pentru a seta coordonatele': {'en': 'Click on map to set coordinates'},
    'Mapbox token nu e configurat': {'en': 'Mapbox token not configured'},
    'Pentru a vedea harta, seteaza variabila de mediu': {'en': 'To see the map, set environment variable'},
    'cu un token public Mapbox (pk.*).': {'en': 'with a public Mapbox token (pk.*).'},
    'Geocodarea automata e indisponibila (lipseste MAPBOX_PUBLIC_TOKEN / MAPBOX_SECRET_TOKEN). Introdu coordonatele manual sau click pe harta.':
        {'en': 'Auto-geocoding unavailable (MAPBOX_PUBLIC_TOKEN/SECRET_TOKEN missing). Enter coordinates manually or click on map.'},
    'Harta interactiva e indisponibila fara MAPBOX_PUBLIC_TOKEN.':
        {'en': 'Interactive map unavailable without MAPBOX_PUBLIC_TOKEN.'},
    'Santier': {'en': 'Site'},
    'Birou': {'en': 'Office'},
    'Depozit': {'en': 'Depot'},
    'Altul': {'en': 'Other'},
    ...
    'Inactiv': {'en': 'Inactive'},
    'Fara': {'en': 'None'},
    'Ex: Santier Strada Stefan cel Mare': {'en': 'E.g.: Site Stefan cel Mare Street'},
    'Ex: Strada Stefan cel Mare 15': {'en': 'E.g.: Stefan cel Mare Street 15'},

    # === Auto-pricing devize ===
    'Auto-pricing': {'en': 'Auto-pricing'},
    'Auto-pricing oferta': {'en': 'Offer auto-pricing'},
    'Auto-pricing deviz': {'en': 'BoQ auto-pricing'},
    'Distribuie un total global pe toate pozitiile, ponderat cu cantitate x tarif x factor. Suma pozitiilor = totalul exact.':
        {'en': 'Distributes a global total across all items, weighted by quantity x tariff x factor. Sum of items = exact total.'},
    'Clasificare categorii lucrare': {'en': 'Work category classification'},
    'Categorie lucrare': {'en': 'Work category'},
    'Categorii distincte': {'en': 'Distinct categories'},
    'Neclasificate (Diverse)': {'en': 'Unclassified (Misc)'},
    'Vezi distributia pe categorii': {'en': 'View category distribution'},
    'Nr. pozitii': {'en': 'Items count'},
    'Pozitii neclasificate': {'en': 'Unclassified items'},
    'Ajusteaza tarifele pe categorie': {'en': 'Adjust category tariffs'},
    'Parametri pricing': {'en': 'Pricing parameters'},
    'Total global fara TVA (RON)': {'en': 'Global total excl. VAT (RON)'},
    'Sugerat (din tarife)': {'en': 'Suggested (from tariffs)'},
    '% Material': {'en': '% Material'},
    'Restul = manopera': {'en': 'Rest = labor'},
    'Seed factor': {'en': 'Factor seed'},
    'Pentru reproducere': {'en': 'For reproducibility'},
    'Pozitiile sunt FARA TVA. Preturile existente vor fi suprascrise. Suma pozitiilor va fi egala cu totalul global (reconciliere automata).':
        {'en': 'Items are excl. VAT. Existing prices will be overwritten. Sum of items equals global total (auto-reconciliation).'},
    'Aplica pricing': {'en': 'Apply pricing'},
    'Aplici pricing? Preturile existente vor fi suprascrise.':
        {'en': 'Apply pricing? Existing prices will be overwritten.'},
    'Tarife': {'en': 'Tariffs'},
    'Tarife pe categorie': {'en': 'Category tariffs'},
    'Tarife pe categorie de lucrare': {'en': 'Work category tariffs'},
    'Aceste tarife (lei/UM orientativ) ponderează distribuția la auto-pricing. Editarile se salveaza ca override pe proiect.':
        {'en': 'These tariffs (lei/UM indicative) weight the auto-pricing distribution. Edits are saved as project override.'},
    'Tarif baza (lei/UM)': {'en': 'Base tariff (lei/UM)'},
    'Sursa': {'en': 'Source'},
    'Global': {'en': 'Global'},
    'Salveaza tarife (override proiect)': {'en': 'Save tariffs (project override)'},
    'Adauga legatura cu Termen contractual': {'en': 'Add link to Contractual deadline'},
